...
class Wechat
{
	...
	public function __construct()
	{
		...
		$this->_ci->config->load('weichat');
		$this->token = !empty($this->_ci->config->item('token'))?$this->_ci->config->item('token'):'';
		$this->appid = !empty($this->_ci->config->item('appid'))? $this->_ci->config->item('appid') :'';
		$this->appsecret = !empty($this->_ci->config->item('appsecret'))?$this->_ci->config->item('appsecret'):'';
		$this->debug = !empty($this->_ci->config->item('debug'))?$this->_ci->config->item('debug'):false;
		$this->_logcallback = !empty($this->_ci->config->item('logcallback'))?$this->_ci->config->item('logcallback'):false;
		$this->partnerid  = !empty($this->_ci->config->item('partnerid'))  ? $this->_ci->config->item('partnerid')  : '';
		$this->partnerkey = !empty($this->_ci->config->item('partnerkey')  ? $this->_ci->config->item('partnerkey') : '';
		$this->paysignkey = !empty($this->_ci->config->item('paysignkey')  ? $this->_ci->config->item('paysignkey') : '';
